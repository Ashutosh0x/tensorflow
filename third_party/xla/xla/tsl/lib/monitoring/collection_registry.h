...
// registry globally.
//
// The exporter will be added to the list of exporters when the object is
// constructed, and will be deferred to export metrics when
// PeriodicallyExportMetrics() is called, which should be called once at the
// beginning of the program. Thus this also requires the main program to call
// ExporterRegistration::PeriodicallyExportMetrics() after the initialization.
// This is also to ensure that all exporters are being called after the flags
// are parsed.
//
// Example usage:
//
...
//
// Call PeriodicallyExportMetrics() in main():
// int main() {
//   ...
//   ExporterRegistration::PeriodicallyExportMetrics();
//   ...
// }
//
